...
?>
    ...
    <section class="countdown2 cid-qOTPHuD2Jj" id="countdown2-r" style="padding-bottom: 30px;">
        <div class="container">
            <h2 class="mbr-section-title pb-3 align-center mbr-fonts-style display-2">Privacy Policy</h2>
        </div>
    </section>

    <section class="mbr-section article content11 cid-qXEwJVXApg" id="content11-z" style="padding-top: 0px;">
        <div class="container">
            <div class="media-container-row">
                <div class="mbr-text counter-container col-12 col-md-8 mbr-fonts-style display-7">
                    <p>Effective date: July 13, 2018</p>

                    <p>PT Tanair Media Seruni (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;) operates the
                    <a href="http://www.mediavista.id">http://www.mediavista.id</a> website and the MEDIAVISTA mobile application (the &quot;Service&quot;).</p>

                    <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when
                    you use our Service and the choices you have associated with that data. This Privacy Policy for PT Tanair Media
                    Seruni is powered by <a href=
                    "https://privacypolicies.com/free-privacy-policy-generator/">PrivacyPolicies.com</a>.</p>
                    ...
                    <p>When you access the Service by or through a mobile device, this Usage Data may include information such as
                    the type of mobile device you use, your mobile device unique ID, the IP address of your mobile device, your
                    mobile operating system, the type of mobile Internet browser you use, unique device identifiers and other
                    diagnostic data.</p>
                    ...
                    <p>PT Tanair Media Seruni uses the collected data for various purposes:</p>
                    ...
                    <p>If you are located outside Indonesia and choose to provide information to us, please note that we transfer
                    ...
                    <p>PT Tanair Media Seruni will take all steps reasonably necessary to ensure that your data is treated securely
                    ...
                    <p>PT Tanair Media Seruni may disclose your Personal Data in the good faith belief that such action is
                    necessary to:</p>

                    <ul>
                        <li>To comply with a legal obligation</li>

                        <li>To protect and defend the rights or property of PT Tanair Media Seruni</li>
                    ...
                    Providers&quot;), to provide the Service on our behalf, to perform Service-related services or to assist us in
                    ...
                    <ul>
                        <li>
                            ...
                            web page: <a href=
                            "https://policies.google.com/privacy?hl=en">https://policies.google.com/privacy?hl=en</a></p>
                        </li>
                    </ul>
                    ...
                    <ul>
                        <li>By email: <a href="mailto:info@media-vista.com">info@media-vista.com</a></li>

                        <li>By visiting this page on our website: <a href="http://www.mediavista.id">http://www.mediavista.id</a></li>
                    </ul>
                </div>
            </div>
        </div>
