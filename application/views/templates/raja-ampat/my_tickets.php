...
?>
            ...
            <tr>
			  ...
			  <td class="body-item mbr-fonts-style text-monospace text-center"><a href="/booking/ticket/<?php echo $ticket->uuid; ?>/<?php echo $ticket->event()->code; ?>" target="_blank"><i class="fa fa-ticket"></i></a></td>
			</tr>
<?php
	}
?>
