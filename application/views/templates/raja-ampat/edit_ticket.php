...
<section class="mbr-fullscreen form1 cid-qOZ4PquGYE mbr-parallax-background" id="form1-w">
    <div class="container">
                        ...
                        <div class="row row-sm-offset">
							...
							<div class="col-md-12 multi-horizontal" data-for="id_card_number">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="id_card_number" placeholder="ID Number (Passport)" data-form-field="ID Number (Passport)" required="true" id="id-card-number-form1-w" value="<?php echo set_value('id_card_number', $order_dtl->id_card_number); ?>">
									</div>
								</div>
							<div class="col-md-12 multi-horizontal" data-for="phone">
                                <div class="form-group">
