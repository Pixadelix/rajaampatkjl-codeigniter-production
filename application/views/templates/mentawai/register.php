...
<section class="cid-qOTOTVrHzg mbr-fullscreen mbr-parallax-background" id="header15-p">
    <div class="mbr-overlay" style="opacity: 0.9; background-color: rgba(228, 210, 149);"></div>
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="media-container-column col-xs-12 col-lg-6" data-form-type="formoid">
