    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
				...
				<h3 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5">Effective date: July 13, 2018</h3>
			</div>
        </div>
    </div>
</section>
	...
	<div class="container">
        <div class="media-container-row">
            <div class="mbr-text col-12 col-md-8 mbr-fonts-style display-7">
				...
				<p>PT Selangit Utama (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;) operates the
				<a href="//www.mentawaisr.com">www.mentawaisr.com</a> website and the MENTAWAI KJL mobile application (the &quot;Service&quot;).</p>

				<p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when
				you use our Service and the choices you have associated with that data. This Privacy Policy for PT Selangit Utama
				is powered by <a href=
				...
				<p>PT Selangit Utama uses the collected data for various purposes:</p>
				...
				<p>PT Selangit Utama will take all steps reasonably necessary to ensure that your data is treated securely
				...
				<p>PT Selangit Utama may disclose your Personal Data in the good faith belief that such action is
				necessary to:</p>

				<ul>
					<li>To comply with a legal obligation</li>

					<li>To protect and defend the rights or property of PT Selangit Utama</li>
				...
				<ul>
					<li>By email: <a href="mailto:selangit_utama@gmail.com">selangit_utama@gmail.com</a></li>
				</ul>
			</div>
		</div>
	</div>
