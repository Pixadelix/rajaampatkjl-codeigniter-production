<?php
$parent_resources = Model\Setting\Acl_resource::result()->order_by('label')->all()->to_array();
?>
...
<?php
							...
							<div class="form-group has-warning">
								...
								<input type="text" class="form-control" id="code" name="code" placeholder="Code" value="<?php echo gfsv('code'); ?>">
							...
							<div class="form-group has-warning">
								...
								<input type="text" class="form-control" id="label" name="label" placeholder="Label" value="<?php echo gfsv('label'); ?>">
...
<?php
											$ci =& get_instance();
											$ci->load->model('de/setting/AclResource');
											
											$menu_types = array(
												array('value' => $ci->AclResource::TYPE_SIDEBAR, 'label' => strtoupper($ci->AclResource::TYPE_SIDEBAR)),
												array('value' => $ci->AclResource::TYPE_SIDEBAR_COMMON, 'label' => strtoupper($ci->AclResource::TYPE_SIDEBAR_COMMON)),
												array('value' => $ci->AclResource::TYPE_NAVBAR, 'label' => strtoupper($ci->AclResource::TYPE_NAVBAR)),
												array('value' => $ci->AclResource::TYPE_WEBSVC, 'label' => strtoupper($ci->AclResource::TYPE_WEBSVC)),
											);
...
?>
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="url" name="url" placeholder="URL" value="<?php echo gfsv('url'); ?>">
							...
							<div class="form-group">
								...
								<div class="input-group iconpicker-container">
										<input id="icon" name="icon" data-placement="bottomRight" class="form-control icp icp-auto iconpicker-element iconpicker-input" type="text" value="<?php echo gfsv('icon'); ?>">
						...
						<div class="box-footer">
							<button type="submit" class="btn btn-app"><i class="fa fa-plus"></i> <?php echo 'Create Menu'; ?></button>
