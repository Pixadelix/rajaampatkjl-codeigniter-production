...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<small>List of Countries</small></h1>
	...
	<section class="content">
		<div class="box box-solid box-danger crowded-box">
			...
			<div class="box-body">
                <table id="countries-editor" class="display table table-condensed table-striped table-hover table-bordered" data-page-length="25" style="width:100%">
                </table>
            </div>
			<div class="box-footer">List of countries.</div>
		</div>
    </section>
</div>