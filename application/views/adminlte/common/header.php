...
$navbars = Model\Setting\Acl_resource::where(array(
    'type' => 'navbar'
));
//var_dump($navbars);die;
?>
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="<?php echo base_url('/'); ?>" class="logo">
                ...
                <span class="logo-mini"><img src="<?php echo base_url(LOGO_50); ?>" class="img-responsive"></span>
...
?>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <img src="<?php echo base_url(get_userphoto()); ?>" class="user-image" alt="User Image">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    <img src="<?php echo base_url(get_userphoto()); ?>" class="img-circle" alt="User Image">

                                    <p>
                                        <?php echo get_userfullname(); ?> -
                                        <?php echo get_usercompany(); ?>
