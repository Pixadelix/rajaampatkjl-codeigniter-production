...
<head>
  ...
  <title><?php echo (isset($PAGE_TITLE) ? "$PAGE_TITLE - " : '').isset($DEFAULT_PAGE_TITLE) ? $DEFAULT_PAGE_TITLE : PROJECT_NAME; ?></title>
  ...
  <link rel="stylesheet" href="<?php echo base_url('/assets/static/adminlte/css/matrix.css'); ?>">
