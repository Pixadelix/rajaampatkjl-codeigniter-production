...
class Profile extends RA_Controller {
	
	public function __construct() {
		parent::__construct();
		$this->restricted();
		$this->data['PAGE_TITLE'] = 'User Profile';
		$this->breadcrumbs->push('User Profile', '/user/profile');
	...
	{
		$profile = Model\Setting\Users::find($id ? $id : $this->user_id);
    ...
    public function get($id = null) {
        ...
        $this->load->model('de/setting/Users', 'user');
