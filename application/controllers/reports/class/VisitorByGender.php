...
class VisitorByGender {
	...
	public function __construct() {
		...
		$this->CI->data['PAGE_TITLE'] = 'Visitor by Gender';
		$this->CI->breadcrumbs->push('Visitor by Gender', '/report/visitor-by-gender');
		$this->CI->enqueue_resource('resource/script/adminlte/reports/js/visitor_by_gender.php');
...
SELECT s.gender,
 ...
 WHERE year(s.ticket_start_date) = :year
   $country_filter
 GROUP BY s.gender, year";
	}
