...
$CI =& get_instance();
#die(var_dump($CI->config->item('notification_email')));
 ...
 */
$config['site_title']                 = PROJECT_NAME; //"Raja Ampat";        // Site Title, example.com
$config['admin_email']                = $CI->config->item('notification_email'); //"admin@localhost";   // Admin Email, admin@example.com
