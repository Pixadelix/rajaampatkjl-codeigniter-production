...
class User extends Base_Model
{
	...
	function login($user_email, $user_pass)
	{
		...
		$this->session->set_userdata( 'app_user_id', $user_id );
		...
		$this->session->set_userdata( 'is_frontend_user', $is_frontend_user );
	...
	function is_logged_in()
	{
		...
		return $this->session->userdata('app_user_id')!=false;
	}
	...
	function get_logged_in_user_info()
	{
		...
		// if the user is already logged in
			...
			$user_id = $this->session->userdata('app_user_id');
	...
	function get_adapter_object( $user )
	{
		...
		$obj->profile_photo = ( isset( $user->profile_photo ))? $user->profile_photo: "default_user_profile.png";
